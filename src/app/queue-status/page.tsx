      ...
      <main className="flex-1 container mx-auto p-4 md:p-6 lg:p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground mt-2">
            Time your visit perfectly. Last updated: {new Date().toLocaleTimeString()}.
          </p>
        </div>
          ...
          {nowServing ? (
             ...
             <CardContent>
               <div className="flex items-center space-x-4">
                 ...
                 <div>
                   <p className="text-2xl font-bold">{anonymizeName(nowServing.name)}</p>
                   <p className="text-muted-foreground">
                    Appointment at {new Date(nowServing.appointmentTime).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                   </p>
                 </div>
               </div>
             </CardContent>
...
// Add a meta tag to refresh the page every 30 seconds
