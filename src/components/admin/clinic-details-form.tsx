           ...
           <div className="space-y-2">
            ...
            <div className="space-y-2">
                ...
                <Input
                    ...
                    name="bookingFee"
                    type="number"
                    value={details.bookingFee ?? ''}
                    onChange={handleInputChange}
                    placeholder="Enter booking fee (e.g. 50)"
                />
                <p className="text-sm text-muted-foreground">
                    This small amount is taken only to confirm booking.
                    Full consultation fee is payable at the clinic.
